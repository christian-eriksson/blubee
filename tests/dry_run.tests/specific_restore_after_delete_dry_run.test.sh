...
config_path="$test_dir/specific_restore_after_delete_dry_run.config"
restore_backup_copy_path="$test_dir/specific_restore_after_delete_dry_run.restore_backup"
...
echo "specific_restore_after_delete_dry_run.test.sh\nRESULTS:"
