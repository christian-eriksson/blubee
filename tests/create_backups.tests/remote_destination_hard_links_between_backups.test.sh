...
script_name="remote_destination_hard_links_between_backups.test.sh"
relative_dir="${0%/*}"
cd $relative_dir
test_dir="$(pwd)"
cd ..
...
backup_json="$test_dir/remote_destination_hard_links_between_backups.backup.json"
backup_dir="$test_dir/remote_destination_hard_links_between_backups.backup"
root="$test_dir/test_files_root"
root_copy="$test_dir/test_files_root_remote_destination_hard_links_between_backups.copy"
cp -r $root $root_copy
